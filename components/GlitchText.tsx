...
const GlitchText: FC<GlitchTextProps> = ({
  ...
  const baseClasses = 'text-current text-[inherit] font-black relative mx-auto select-none cursor-pointer';
  ...
  const combinedClasses = `glitch-text ${baseClasses} ${pseudoClasses} ${className}`;
