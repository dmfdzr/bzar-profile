...
const copy = {
    ...
    id: {
        title: "Proyek & eksplorasi yang dapat dilacak.",
        description: "Panel ini menarik data secara langsung dari repositori publik GitHub, lalu menampilkannya dalam format portofolio yang lebih terstruktur.",
        badge: "projects.api",
        sourceGithub: "Diambil langsung dari GitHub",
        sourceUnavailable: "GitHub tidak dapat diakses",
        loading: "Mensinkronisasi repositori",
        retry: "Coba lagi",
        live: "Live",
        source: "Kode Sumber",
        latest: "Terbaru",
        updated: "Diperbarui",
        stack: "Teknologi",
        gallery: "Galeri repositori",
        previous: "Proyek sebelumnya",
        next: "Proyek berikutnya",
        openRepo: "Buka repositori",
        empty: "Data proyek belum tersedia saat ini.",
        filteredEmpty: "Tidak ada proyek yang sesuai dengan pencarian ini.",
        stats: ["proyek", "tautan live", "terbaru"],
    },
};
