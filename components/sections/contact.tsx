...
const copy = {
    ...
    id: {
        command: "$ koneksi --tujuan kolaborasi",
        title: "Mari ciptakan solusi.",
        description: "Saya sangat terbuka untuk peluang karier, proyek web, perbaikan operasional TI, atau sekadar berdiskusi seputar teknologi.",
        availability: "Status",
        availabilityValue: "Menerima tawaran posisi Application Support & Web Developer",
        response: "Gaya Komunikasi",
        responseValue: "Praktis, langsung pada intinya, tanpa basa-basi",
        primary: "Kirim Email",
        github: "Buka GitHub",
        linkedin: "Buka LinkedIn",
        direct: "Akses Langsung",
        directValue: "Silakan hubungi saya kapan saja melalui tautan berikut.",
    },
};
